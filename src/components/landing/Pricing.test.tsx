...
jest.mock('framer-motion', () => ({
    motion: {
        div: function MotionDiv({ children, ...props }: any) { return <div {...props}>{children}</div> },
        h2: function MotionH2({ children, ...props }: any) { return <h2 {...props}>{children}</h2> },
        h3: function MotionH3({ children, ...props }: any) { return <h3 {...props}>{children}</h3> },
        p: function MotionP({ children, ...props }: any) { return <p {...props}>{children}</p> },
    },
    useInView: () => true,
}))
