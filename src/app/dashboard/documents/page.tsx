        ...
        <div className="space-y-6 font-poppins">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="flex items-center justify-center px-4 py-2 bg-[#4A90E2] text-white rounded-lg hover:bg-[#4A90E2]/90 font-bold transition-colors shadow-md"
                >
            ...
            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col sm:flex-row gap-4">
                <div className="flex-1 relative">
                    <input
                        ...
                        className="w-full pl-4 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A90E2]/20 focus:border-[#4A90E2] transition-all text-gray-900 placeholder-gray-400"
                    />
                </div>
                <div className="flex gap-4">
                    <select
                        ...
                        className="px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A90E2]/20 focus:border-[#4A90E2] bg-white text-gray-700"
                    >
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-12 flex flex-col items-center justify-center text-center">
                    ...
                    {(searchQuery || filterType !== 'all') ? (
                        <button
                            ...
                            className="px-4 py-2 text-[#4A90E2] hover:text-[#4A90E2]/80 font-medium"
                        >
                            Clear Filters
                        </button>
                    ) : (
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {filteredDocuments.map((doc) => (
                                    <tr key={doc.id} className={`hover:bg-gray-50 transition-colors group ${selectedDocuments.has(doc.id) ? 'bg-blue-50/50' : ''}`}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <div className={`p-2 rounded-lg mr-3 ${doc.file_type.includes('pdf') ? 'bg-red-50 text-red-600' :
                                                    doc.file_type.includes('image') ? 'bg-blue-50 text-[#4A90E2]' :
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-gray-500">Project Document</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
